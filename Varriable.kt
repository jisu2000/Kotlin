fun main() {
    ...
    // println("First Charracter $firCharInStr")
    // println("Last Charracter $lastCharInStr")
    // println("The Length of the String is ${myStr.length}")

    var mynum=10;
    println(mynum)
    mynum++
    println(mynum)
    println("the number is ${mynum++}")
    println(mynum)
    println("The number become ${++mynum}")
